...
class DataConfig:
    train_files: str = ""
    val_files: str = ""
    output_result_dir: str="results"
    prompt_key: str = "prompt"
    answer_key: str = "answer"
    image_key: str = "images"
    val_prompt_key: Optional[str] = "instruction"
    val_answer_key: Optional[str] = "output"
