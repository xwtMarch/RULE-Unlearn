import torch
import os
from ..inference import generate_completions_eval, generate_completions_group_vllm
from rouge import Rouge
import json


@torch.no_grad()
def eval_neighbor(model, tokenizer, level1, level2, batch_size=1, output_result_dir=None, use_prompt=False, eval_config=None):
