...
from .actor import ActorConfig, FSDPConfig, ModelConfig, OptimConfig, RefConfig, NoiseRolloutConfig
...
class WorkerConfig:
    ...
    noise_rollout: NoiseRolloutConfig = field(default_factory=NoiseRolloutConfig)
