...
do
    ...
    do
        ...
        mkdir -p ${save_dir}
        experiment_name=exp/llama_3_8b_rj_step${checkpint}_rl_bs32_kl1_guide_bf16_two_stage_instruct_ref_rollout8_withformat_reject_data_only_with_fb
        ...
        python3 -m verl.trainer.main \
            ...
            data.train_files=data/RWKU/Target/${name}/rl_rejection_with_fb_reject_only.json\
            ...
            worker.reward.score_function="forget_two_stage" \
