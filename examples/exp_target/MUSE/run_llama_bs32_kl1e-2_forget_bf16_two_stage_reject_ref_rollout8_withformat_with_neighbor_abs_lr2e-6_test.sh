...
do
    ...
    do
        ...
        mkdir -p ${save_dir}
        experiment_name=MUSE/exp_target/llama_2_7b_rj_step${checkpint}_bs32_kl1e-2_bf16_two_stage_reject_ref_rollout8_withformat_with_neighbor_abs_lr2e-6_test
        ...
        MODEL_PATH=/mnt/usercache/zhangchenlong/MUSE-books_target
