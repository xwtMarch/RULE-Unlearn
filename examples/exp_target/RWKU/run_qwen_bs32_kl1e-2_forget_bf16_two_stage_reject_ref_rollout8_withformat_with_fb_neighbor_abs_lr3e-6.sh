...
do
    ...
    do
        ...
        mkdir -p ${save_dir}
        experiment_name=RWKU/exp_target/qwen/Qwen2.5-3B_rj_step${checkpint}_bs32_kl1e-2_bf16_two_stage_reject_ref_rollout8_withformat_with_fb_neighbor_abs_target_lr3e-6
        MODEL_PATH=/mnt/usercache/zhangchenlong/RL-Unlearning/LLaMA-Factory/saves/RWKU/Target/${name}/rt_target_full/qwen2.5_3b_instruct_bf16/checkpoint-${checkpint}  # replace it with your local file path
