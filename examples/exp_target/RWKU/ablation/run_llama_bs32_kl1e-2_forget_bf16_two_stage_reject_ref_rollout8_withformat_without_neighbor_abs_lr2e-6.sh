...
do
    ...
    do
        ...
        mkdir -p ${save_dir}
        experiment_name=RWKU/exp_target/ablation/llama_3_8b_rj_step${checkpint}_rl_bs32_kl1e-2_bf16_two_stage_reject_ref_rollout8_withformat_with_fb_abs_target_lr2e-6
        ...
        python3 -m verl.trainer.main \
            ...
            data.train_files=data/RWKU/Target/${name}/rl_rejection_with_fb_target.json\
