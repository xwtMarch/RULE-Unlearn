...
do
    ...
    do
        ...
        mkdir -p ${save_dir}
        experiment_name=RWKU/exp_target/ablation/llama_3_8b_rj_step${checkpint}_bs32_kl1e-2_bf16_two_stage_reject_ref_rollout8_withformat_with_fb_neighbor_abs_target_lr2e-6_ppo
