...
do
    ...
    do
        ...
        mkdir -p ${save_dir}
        experiment_name=RWKU/exp_target/ablation/llama_3_8b_rj_step${checkpint}_bs32_kl1e-2_bf16_two_stage_reject_ref_rollout8_withformat_with_fb_neighbor_abs_target_lr2e-6_rpp_3.1
        MODEL_PATH=/mnt/usercache/zhangchenlong/RL-Unlearning/LLaMA-Factory/saves/RWKU/Target/${name}/rt_target_full/llama3.1_8b_instruct_bf16/checkpoint-${checkpint}  # replace it with your local file path
        ...
        python3 -m verl.trainer.main \
            config=examples/rpp_rj_rl.yaml \
