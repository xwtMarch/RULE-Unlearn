...
do
    ...
    do
        ...
        mkdir -p ${save_dir}
        experiment_name=RWKU/exp_target/ablation/llama_3_8b_instruct_step${checkpint}_bs32_kl1e-2_bf16_two_stage_instruct_ref_rollout8_withformat_with_fb_neighbor_abs_target_lr2e-6
        ...
        python3 -m verl.trainer.main \
            ...
            worker.actor.model.model_path=/mnt/usercache/huggingface/Meta-Llama-3-8B-Instruct \
