...
class DataArguments:
    ...
    eval_metrics: List[str] = field(
        default_factory=lambda: ["forget", "neighbor"],
        metadata={"help": "List of evaluation metrics to use. Multiple metrics can be specified as a list of strings. Choices: forget, neighbor, mmlu, bbh, truthfulqa, triviaqa, mia, fluency"},
    )
    val_strategy: Literal["epoch", "step", "None"] = field(
        default="step",
